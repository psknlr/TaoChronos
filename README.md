...
| 影像见证：日本国文学研究资料馆（研医会、庆应与京大富士川文库、东大含鹗轩文库、九大、东北大）、柏林国家图书馆文树德藏品、美国国会图书馆中文善本、早稻田古典籍、日本国会图书馆 | 各馆授权逐条记录 | 书目记录 书目 **8,928 条**（关联到 141 部著作的 342 条） | 只收题名、年代、刻/写、藏所、索书号、IIIF 清单与授权，按题名关联到库中著作；不下载影像 |
